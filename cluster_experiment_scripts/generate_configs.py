...
config_list = [config(experiment_name='experiment_1_1', dataset_name='cifar10', seed=0,
               ...
               config(experiment_name='experiment_5_1', dataset_name='cifar10', seed=0,
                      attention_pooling_type='avg_pool',
                      ...
                      conv_bn_relu_type_bottleneck='WeightAttentionalConv2dNormLeakyReLU',
                      conv_bn_relu_type_processing='Conv2dNormLeakyReLU'),
               config(experiment_name='experiment_5_2', dataset_name='cifar10', seed=1,
                      attention_pooling_type='avg_pool',
                      attention_network_type='fcc_network',
                      attention_pooling_size=1,
                      num_attention_layers=2,
                      ...
                      conv_bn_relu_type_bottleneck='WeightAttentionalConv2dNormLeakyReLU',
                      conv_bn_relu_type_processing='Conv2dNormLeakyReLU'),
               config(experiment_name='experiment_5_3', dataset_name='cifar10', seed=2,
                      attention_pooling_type='avg_pool',
                      attention_network_type='fcc_network',
                      attention_pooling_size=1,
                      num_attention_layers=2,
               ...
               config(experiment_name='experiment_6_1', dataset_name='cifar10', seed=0,
                      attention_pooling_type='avg_pool',
                      attention_network_type='fcc_network',
                      attention_pooling_size=1,
                      num_attention_layers=3,
                      ...
                      conv_bn_relu_type_bottleneck='WeightAttentionalConv2dNormLeakyReLU',
                      conv_bn_relu_type_processing='Conv2dNormLeakyReLU'),
               config(experiment_name='experiment_6_2', dataset_name='cifar10', seed=1,
                      attention_pooling_type='avg_pool',
                      attention_network_type='fcc_network',
                      attention_pooling_size=1,
                      num_attention_layers=3,
                      ...
                      conv_bn_relu_type_bottleneck='WeightAttentionalConv2dNormLeakyReLU',
                      conv_bn_relu_type_processing='Conv2dNormLeakyReLU'),
               config(experiment_name='experiment_6_3', dataset_name='cifar10', seed=2,
                      attention_pooling_type='avg_pool',
                      attention_network_type='fcc_network',
                      attention_pooling_size=1,
                      num_attention_layers=3,
               ...
               config(experiment_name='experiment_7_1', dataset_name='cifar10', seed=0,
                      attention_pooling_type='avg_pool',
                      attention_network_type='fcc_network',
                      attention_pooling_size=3,
                      num_attention_layers=3,
                      ...
                      conv_bn_relu_type_bottleneck='WeightAttentionalConv2dNormLeakyReLU',
                      conv_bn_relu_type_processing='Conv2dNormLeakyReLU'),
               config(experiment_name='experiment_7_2', dataset_name='cifar10', seed=1,
                      attention_pooling_type='avg_pool',
                      attention_network_type='fcc_network',
                      attention_pooling_size=3,
                      num_attention_layers=3,
                      ...
                      conv_bn_relu_type_bottleneck='WeightAttentionalConv2dNormLeakyReLU',
                      conv_bn_relu_type_processing='Conv2dNormLeakyReLU'),
               config(experiment_name='experiment_7_3', dataset_name='cifar10', seed=2,
                      attention_pooling_type='avg_pool',
                      attention_network_type='fcc_network',
                      attention_pooling_size=3,
                      num_attention_layers=3,
               ...
               config(experiment_name='experiment_8_1', dataset_name='cifar10', seed=0,
                      attention_pooling_type='avg_pool',
                      attention_network_type='fcc_network',
                      attention_pooling_size=3,
                      num_attention_layers=4,
                      ...
                      conv_bn_relu_type_bottleneck='WeightAttentionalConv2dNormLeakyReLU',
                      conv_bn_relu_type_processing='Conv2dNormLeakyReLU'),
               config(experiment_name='experiment_8_2', dataset_name='cifar10', seed=1,
                      attention_pooling_type='avg_pool',
                      attention_network_type='fcc_network',
                      attention_pooling_size=3,
                      num_attention_layers=4,
                      ...
                      conv_bn_relu_type_bottleneck='WeightAttentionalConv2dNormLeakyReLU',
                      conv_bn_relu_type_processing='Conv2dNormLeakyReLU'),
               config(experiment_name='experiment_8_3', dataset_name='cifar10', seed=2,
                      attention_pooling_type='avg_pool',
                      attention_network_type='fcc_network',
                      attention_pooling_size=3,
                      num_attention_layers=4,
