...
config_list = [config(experiment_name='experiment_1_1', dataset_name='cifar100', seed=0,
               ...
               config(experiment_name='experiment_2_1', dataset_name='cifar100', seed=0,
                      attention_pooling_type='max_pool',
                      attention_network_type='relational_network',
                      ...
                      conv_bn_relu_type_bottleneck='WeightAttentionalConv2dNormLeakyReLU',
                      conv_bn_relu_type_processing='Conv2dNormLeakyReLU'),
               config(experiment_name='experiment_2_2', dataset_name='cifar100', seed=1,
                      attention_pooling_type='max_pool',
                      attention_network_type='relational_network',
                      attention_pooling_size=3,
                      num_attention_layers=3,
                      ...
                      conv_bn_relu_type_bottleneck='WeightAttentionalConv2dNormLeakyReLU',
                      conv_bn_relu_type_processing='Conv2dNormLeakyReLU'),
               config(experiment_name='experiment_2_3', dataset_name='cifar100', seed=2,
                      attention_pooling_type='max_pool',
                      attention_network_type='relational_network',
                      attention_pooling_size=3,
                      num_attention_layers=3,
               ...
               config(experiment_name='experiment_4_1', dataset_name='cifar100', seed=0,
                      attention_pooling_type='max_pool',
                      attention_network_type='relational_network',
                      attention_pooling_size=3,
                      num_attention_layers=4,
                      ...
                      conv_bn_relu_type_bottleneck='WeightAttentionalConv2dNormLeakyReLU',
                      conv_bn_relu_type_processing='Conv2dNormLeakyReLU'),
               config(experiment_name='experiment_4_2', dataset_name='cifar100', seed=1,
                      attention_pooling_type='max_pool',
                      attention_network_type='relational_network',
                      attention_pooling_size=3,
                      num_attention_layers=4,
                      ...
                      conv_bn_relu_type_bottleneck='WeightAttentionalConv2dNormLeakyReLU',
                      conv_bn_relu_type_processing='Conv2dNormLeakyReLU'),
               config(experiment_name='experiment_4_3', dataset_name='cifar100', seed=2,
                      attention_pooling_type='max_pool',
                      attention_network_type='relational_network',
                      attention_pooling_size=3,
                      num_attention_layers=4,
