...
python train_evaluate_emnist_classification_system.py --batch_size $batch_size$ --continue_from_epoch -1 --seed $seed$ \
                                                      --image_num_channels 3 --image_height 32 --image_width 32 \
                                                      --num_epochs $num_epochs$ --experiment_name $experiment_name$ \
                                                      --growth_rate $growth_rate$ --block_config "(5, 5, 5, 5)" --compression 0.5 \
